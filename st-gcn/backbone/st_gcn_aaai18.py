...
from backbone.st_gcn.graph import Graph
from backbone.st_gcn.gconv_origin import ConvTemporalGraphical
from backbone.lstm import SimpleLSTM
...
class ST_GCN_18(nn.Module):
    ...
    Args:
        ...
        hidden_size (int): Number of hidden units on LSTM
        num_layers (int): Number of LSTM layers
        bidirectional (bool): If true, it becomes a bidirectional LSTM
    ...
    def forward(self, x):
        ...
        # print(f'\nSequence length: {T}')
        # print(f'x.shape (before ST-GCN): {x.shape}')
