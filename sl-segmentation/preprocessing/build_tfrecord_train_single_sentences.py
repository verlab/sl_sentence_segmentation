...
if __name__ == '__main__':
    ...
    # read split csv
    dev_csv = pd.read_csv('./data/single_sentence_dev_frames.csv')
    test_csv = pd.read_csv('./data/single_sentence_test_frames.csv')
    train_csv = pd.read_csv('./data/single_sentence_train_frames.csv')
